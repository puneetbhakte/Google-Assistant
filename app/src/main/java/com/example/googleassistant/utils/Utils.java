...
public class Utils {
    ...
    public static void ActionBar(ActionBar supportActionBar, Context context) {
  ...
  //  public static void setCustomActionBar(Fragment fragment, Context context) {
    //    ActionBar(((AppCompatActivity) fragment.requireActivity()).getSupportActionBar(), context);
    //}
