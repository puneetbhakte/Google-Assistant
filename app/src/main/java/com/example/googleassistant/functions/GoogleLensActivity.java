...
import com.example.googleassistant.databinding.ActivityGoogleLensBinding;
...
public class GoogleLensActivity extends AppCompatActivity {
    ...
    private ActivityGoogleLensBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityGoogleLensBinding.inflate(getLayoutInflater());
...
//        assert actionBar != null;
     //  actionBar.setSubtitle("Insert or Click Photos");
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("Google Lens");
        }
        binding.toolbar2.setSubtitle("Insert or Click Photos");
        ...
        binding.button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String nm =binding.resultedt.getText().toString();
                if (!nm.isEmpty()) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                binding.ImageViewpre.setImageURI(resultUri);

                BitmapDrawable bitmapDrawable = (BitmapDrawable) binding.ImageViewpre.getDrawable();
                ...
                if (!recognizer.isOperational()) {
                    ...
                    binding.resultedt.setText(sb.toString());
                }
